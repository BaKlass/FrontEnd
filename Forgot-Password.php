      ...
      <div class="row" id="alertSuccess">
      	<div class="col-lg-12">
			...
			<form method="post" id="loginForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<input type="text" class="login-form" name="email" dir="ltr" placeholder="ایمیل " style="text-align: center;width:400px" value="">
				<input type="text" class="login-form" name="username" dir="ltr" placeholder="نام کاربری " style="text-align: center;width:400px" value="">
