...
<div class="row">
	<div class="col-8 text-right">
		<h3 class="header-title">پیام  های دریافتی</h3>
	</div>
		...
		<table class="table text-center table-bordered table-hover table-sm table-striped">
			...
			<tbody>
				<tr>
					...
					<td>1398</td>
					<td class="table-btn">
						<button class="btn btn-outline-dark btn-sm col-lg-5 col-5" data-toggle="modal" title="مشاهده پیام" data-target="#see"><i class="fa fa-eye"></i>
						</button> <a href="#" class="btn btn-outline-success btn-sm col-lg-5 col-5"><i class="fa fa-check"></i></a>
					</td>
				</tr>
			</tbody>
		</table>
