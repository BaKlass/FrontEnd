...
<div class="row">
	<div class="col-8 text-right">
		<h3 class="header-title">دروس ارائه شده</h3>
	</div>
			...
			<tbody>
				<tr>
					...
					<td class="table-btn">
						...
						</button> <a href="#" class="btn btn-outline-success btn-sm col-lg-5 col-5" title="اخذ درس"><i class="fa fa-calendar-check"></i></a>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="col-12">
					<div class="col-12"> <a href="#" class="btn btn-success btn-sm btn-block">اخذ درس</a>
